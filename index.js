$(function(){
    ...
    function getValue(forindex) {
        ...
        var xsvg =  '<svg display="block" viewBox="0 0 200 200"><path class="cross1" d="M 50,50 L 150,150" stroke="#666" stroke-width="15" />'
    ...
    function game() {
        ...
        this.initializeUI = function() {
            ...
            var newSettings= {playercount:1, computerTurn:2, difficulty:'easy'};
